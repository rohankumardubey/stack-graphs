...
pub struct Position {
    ...
    pub line: usize,
    /// The offset of the character within its containing line
    pub column: Offset,
    /// The byte offset (within the file) of the line containing the character
    pub containing_line: Range<usize>,
    /// The byte offset (within the file) of the line containing the character, with any leading
